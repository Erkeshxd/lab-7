...
sec = pg.image.load(r"C:\Users\Пользователь\Desktop\clock\leftarm.png").convert_alpha()
minute = pg.image.load(r"C:\Users\Пользователь\Desktop\clock/rightarm.png").convert_alpha()
rectsec = sec.get_rect()
rectmin = minute.get_rect()
rectmin.center = rectsec.center = midle

background = pg.image.load(r"C:\Users\Пользователь\Desktop\clock\mainclock.png").convert_alpha()
run =True
