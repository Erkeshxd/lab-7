...
play = get_image(r"/Users/ersultanersultan/Desktop/pp2/lap7/music/play1.png")
forward = get_image(r"/Users/ersultanersultan/Desktop/pp2/lap7/music/forward1.png")
back = get_image(r"/Users/ersultanersultan/Desktop/pp2/lap7/music/back1.png")
folder = get_image(r"/Users/ersultanersultan/Desktop/pp2/lap7/music/folder.png")
clear = get_image(r"/Users/ersultanersultan/Desktop/pp2/lap7/music/clear.png")
...
class MusicPlayer():
    def __init__(self):
        ...
        self.volume = 1.0
        self.index = 0
        self.dynamic_play = get_image(r"/Users/ersultanersultan/Desktop/pp2/lap7/music/21 Savage – redrum.mp3")
    ...
    def play_function(self):
        ...
        try:
            ...
            self.started = True
            self.dynamic_play= get_image(r"/Users/ersultanersultan/Desktop/pp2/lap7/music/pause1.png")
        except:
    ...
    def pause_function(self):
        if self.paused:
            ...
            self.paused = True
            self.channel.pause()
            self.dynamic_play = get_image(r"/Users/ersultanersultan/Desktop/pp2/lap7/music/play1.png")
...
music_player.read_songlist("song.json")
...
music_player.save_songlist("song.json")